    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      ...
      <div className="w-full md:w-64 bg-white border-r border-gray-200 shadow-sm flex flex-col">
        <div className="p-6 border-b border-gray-100 flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-gray-800 text-sm">{user?.displayName || 'User'}</h3>
            <span className="text-xs text-gray-500 uppercase tracking-widest font-semibold text-[10px]">User Panel</span>
          </div>
        </div>
